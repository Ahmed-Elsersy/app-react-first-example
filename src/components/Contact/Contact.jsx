...
export default class Contact extends Component {
  ...
  <div className="container">
    ...
    <h2 className="contact-heading text-center text-uppercase text-secondary mb-0">Contact Me</h2>
    {/* Icon Divider*/}
      ...
      <div className="col-lg-8 mx-auto">
        ...
        <form id="contactForm" name="sentMessage" noValidate="novalidate">
          ...
          <div className="control-group">
            <div className="form-group floating-label-form-group controls mb-0 pb-2">
              <label>Message</label>
              <textarea className="form-control" id="message" rows={5} placeholder="Message" required="required" data-validation-required-message="Please enter a message." spellCheck="false" data-ms-editor="true" defaultValue={""} />
              <p className="help-block text-danger" />
            </div>
          </div>
          <br />
